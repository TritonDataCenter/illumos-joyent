...
chacha_keysetup(chacha_ctx_t *x, const u8 *k, u32 kbits, u32 ivbits __unused)
{
  ...
  x->chacha_input[0] = U8TO32_LITTLE(constants + 0);
  x->chacha_input[1] = U8TO32_LITTLE(constants + 4);
  x->chacha_input[2] = U8TO32_LITTLE(constants + 8);
  x->chacha_input[3] = U8TO32_LITTLE(constants + 12);
}
...
chacha_encrypt_bytes(chacha_ctx_t *x, const u8 *m, u8 *c, u32 bytes)
{
  ...
  j8 = x->chacha_input[8];
  j9 = x->chacha_input[9];
  j10 = x->chacha_input[10];
  j11 = x->chacha_input[11];
  j12 = x->chacha_input[12];
  j13 = x->chacha_input[13];
  j14 = x->chacha_input[14];
  j15 = x->chacha_input[15];
  ...
  for (;;) {
    ...
    if (bytes <= 64) {
      ...
      x->chacha_input[12] = j12;
      x->chacha_input[13] = j13;
      return;
    }
    bytes -= 64;
    c += 64;

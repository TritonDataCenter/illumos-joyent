...
arc_init(void)
{
	 ...
	 *
	 * XXX KEBE SAYS NUKE THIS COMMENT, but this can be independent of a
	 * kick ZFS in the head method like proposed in OS-8638.
	 *
	 * XXX KEBE ALSO SAYS arc_c_max_percent COULD be a
	 * "performance analysis tunable" as well above.
	 */
#if 0 /* Upstream */
	if (allmem >= 1 << 30)
